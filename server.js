...
const binderRoutes = require('./app/routes/binder_routes')
...
app.use(cors({ origin: process.env.CLIENT_ORIGIN ? [process.env.CLIENT_ORIGIN, process.env.CLIENT2_ORIGIN] : `http://localhost:${clientDevPort}` }))
